...
**Кнопка в «рядку/картці з діями» (полоски з кнопками) — завжди зелена контурна:**
- light: bg `#F3FAF6`, border `rgba(16,185,129,0.32)`, hover bg `rgba(16,185,129,0.16)` + border `#10B981`
